...
function activate_plugin_name() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-pms-activator.php';
	Product_Material_Selection_Activator::activate();
}
...
function deactivate_plugin_name() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-pms-deactivator.php';
	Product_Material_Selection_Deactivator::deactivate();
}
 ...
 */
require plugin_dir_path( __FILE__ ) . 'includes/class-pms.php';
...
function run_plugin_name() {
	...
	$plugin = new Product_Material_Selection();
	$plugin->run();
